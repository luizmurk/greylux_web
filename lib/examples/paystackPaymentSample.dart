...
String paystackPublicKey = 'pk_test_b174ae07a4cec85c8324d4d1b574c4898be08d5d';
const String appName = 'Greylux Mobile';

class PayWithPayStack extends StatefulWidget {
  PayWithPayStack({Key key, this.email, this.cardDetails}) : super(key: key);
